import { BookOpen, ChevronRight, Flame, Gem } from "lucide-react";
...
export function UtilitiesPage() {
  return <div className="page-stack compact-page">
    ...
    <div className="archive-grid">
      ...
      <Link className="panel archive-card" to="/spark-savings"><Gem size={24} /><span><strong>天井貯金</strong><small>宝晶石とチケットから天井までを計算</small></span><ChevronRight size={20} /></Link>
    </div>
  </div>;
}
