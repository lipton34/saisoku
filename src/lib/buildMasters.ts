...
export const buildMasterItems: BuildMasterItem[] = [
  ...
  { id: "weapon-ultima-katana", kind: "weapon", name: "オメガ刀", element: "無属性", rarity: "SSR", weaponType: "刀", series: "オメガ", thumbnailPath: "weapons/omega-katana.webp", tags: ["高難度"] },
  ...
  { id: "weapon-water-ougi", kind: "weapon", name: "水属性の奥義寄せ武器", element: "水", rarity: "SSR", series: "奥義", thumbnailPath: "weapons/water-ougi.webp", tags: ["奥義"] },
  { id: "weapon-fire-limited", kind: "weapon", name: "火リミ武器", element: "火", rarity: "SSR", series: "リミテッド", thumbnailPath: "weapons/fire-limited.webp", tags: ["周回"] },
  { id: "weapon-kyokusei", kind: "weapon", name: "極星器", element: "無属性", rarity: "SSR", series: "極星器", thumbnailPath: "weapons/kyokusei.webp", tags: ["周回"] },
  { id: "weapon-hp-flex", kind: "weapon", name: "HPを確保できる武器", element: "可変", rarity: "SSR", thumbnailPath: "weapons/hp-flex.webp", tags: ["耐久"] }
];
